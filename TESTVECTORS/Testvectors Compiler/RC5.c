...
{ WORD i, j, pt1[2], pt2[2], ct[2];
  unsigned char key[b] = {0x00,0x00,0x00,0x00,
                          0x00,0x00,0x00,0x00,
                          0x00,0x00,0x00,0x00,
                          0x00,0x00,0x00,0x00};

  pt1[0] = 0x00000000;  // MSB
  pt1[1] = 0x00000000;  // LSB
  ...
  //if  ( (keyfile = fopen("rc5_1k_test_vectors_keys.txt","w"))==NULL)
  //{
  //    printf("can not open data file\n");
  //	exit(0);
  //}

    // if  ( (ptfile = fopen("rc5_1k_test_vectors_pt.txt","w"))==NULL)
    //{
    //    printf("can not open data file\n");
    //    exit(0);
    //}

     if  ( (ctfile = fopen("rc5_1k_test_vectors.txt","w"))==NULL)
    {
        printf("can not open data file\n");
        exit(0);
    }
